...
module.exports = class ColorPickerAndroid extends Component {
	// testData = {}
	...
	render () {
		...
		return (
			<View style={{ backgroundColor:'#fff',width:Dimensions.get('window').width/1.2,height:Dimensions.get('window').height/2,padding:10}}>
